...
@Configuration
@ConditionalOnProperty(name = "spring.batch.job.names", havingValue = "cu")
@RequiredArgsConstructor
public class CuBatchConfig {
    ...
    public Job createJob() {
        return jobBuilderFactory.get("cu")
                .start(createStep())
                .build();
    }
    ...
    public CvsCrawResultReader crawResultReader() {
        return new CvsCrawResultReader(new CuCrawlerClient(), resultConverter());
    }

    @Bean
    public ResultConverter resultConverter() {
        return new CuCrawlerResultConverter();
    }
